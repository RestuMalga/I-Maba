  ...
  <div class="container">
    <div class="row justify-content-md-center">  
      ...
      <div class="text-center" >
        <h2><b>Rekapitulasi Kehadiran PKKMB</b></h2>
      </div>
    </div>
    <a href="../pkkmb/presensipkkmb.php">
      Back
    </a> 
      ...
      <table class="table table-striped table-sm">
        <thead>
          <tr>
            ...
            <th scope="col">Rangkuman Materi</th>
        ...
        <tbody>
            <?php 
             $no = 1;
             $data = mysqli_query($conn,"select * from absenpkkmb INNER JOIN pkkmb ON absenpkkmb.IdKegiatan = pkkmb.IdKegiatan");
            ...
            ?>
                <tr>
                    ...
                    <td><?php echo $d['NamaKegiatan']; ?></td>
                    <td><?php echo $d['RangkumanMateri']; ?></td>
                    <td><?php echo $d['TanggalKegiatan']; ?></td>
                    <td>
                      <a href="../presensi/editpresensi.php?IdPresensi=<?php echo $d['IdPresensi']; ?>">Edit</a>
					            <a href="../presensi/hapuspresensi.php?IdPresensi=<?php echo $d['IdPresensi']; ?>">Hapus</a>
				            </td>
                </tr>
                <?php 
            }
