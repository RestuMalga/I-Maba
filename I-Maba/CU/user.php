    ...
    <img class="bi me-2" width="40" height="40" src="../res/logo.png">
      ...
      <div class="collapse navbar-collapse" id="navbarNavDarkDropdown ">
        <ul class="navbar-nav me-auto mb-2 mb-md-0">
          ...
          <a href="../CU/user.php" type="button" class="btn btn-outline-light active me-2">USER</a>
...
<div class="container px-1 py-4 text-center" id="hanging-icons">
      <h2><u>Data Mahasiswa</u></h2>
      <br>
      <center><img class="bd-placeholder-img rounded-circle" src="../res/profil.jpg" width="150" height="170">
      <p style="margin: 0%; font-size: 25px;"><b>Dwinda Nur Fadillah</b></p>
      <p class="fst-italic">6304201238/D4 Rekayasa Perangkat Lunak</p>
      </center>
          ...
          <div>
            <p>NIM            : 6304201238</p>
            <P>Jurusan/Prodi  : Teknik Informatika/Rekayasa Perangkat Lunak</P>
            <p>Semester       : 4(empat)</p>
            <p>Jenis Kelamin  : Perempuan</p>
            <p>Alamat         : Jl. Sri Pulau Rupat Utara</p>
          </div>
