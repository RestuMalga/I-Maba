...
<div class="container">
    <div class="row justify-content-md-center">  
      ...
      <h2 style="margin-top: 25px;" class="pb-2 border-bottom"><center>ISI PRESENSI PKKMB</center></h2>
      <form class="row g-3" method="post" action="kehadiranpkkmb_add.php">
        <div class="col-md-6">
          <input type="hidden" name="IdPresensi">
          <label for="name" class="form-label">Nama</label>
          <input type="name" class="form-control" id="name" name="Nama">
        </div>
        <div class="col-md-6">
          <label for="nim" class="form-label">NIM</label>
          <input type="name" class="form-control" id="nim" name="NIM">
        </div>
        <div class="col-md-6">
        ...
        <div class="col-12">
          ...
          <textarea type="text" class="form-control" id="materi" rows="3" name="RangkumanMateri"></textarea>
        </div>
        <div class="col-md-3">
          <label for="Tanggal" class="form-label">Tanggal Kegiatan</label>
          <label for="Tanggal" class="form-label"><i>*ex : 02 Juli 2022</i></label>
          <input type="text" class="form-control" id="Tanggal" name="TanggalKegiatan">
        </div>
