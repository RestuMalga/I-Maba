  ...
  <div class="container marketing">
    ...
    <div class="row justify-content-md-center"> 
      ...
      <div class="text-center" >
        <h2><b>Jadwal PKKMB Politeknik Negeri Bengkalis</b></h2>
      </div>
    </div>
    <h1 style="font-size: xx-large;"> </h1>
      ...
      <table class="table table-striped table-sm">
        ...
        <tbody>
          <tr>
            ...
            <td><a href="../lainnya/unduhSertifikat.php" class="btn btn-primary">unduh</a></td>
          </tr>
          <tr>
            <td>2</td>
            ...
            <td>Belum dilaksanakan</td>
            <td><a href="../lainnya/unduhSertifikat.php" class="btn btn-primary disabled">unduh</a></td>
          </tr>
          <tr>
            <td>3</td>
