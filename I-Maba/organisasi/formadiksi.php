    ...
    <div class="row align-items-md-stretch bg-light border ">
      <div class="col-md-6">
        <div class="h-100 p-5 rounded-3">
          <img class="bi me-3" width="500px" height="350px" src="../res/formadiksi.jpg">
        </div>
      </div>
      <div class="col-md-6">
        <div class="h-100 p-5 rounded-3">
          <h2>Formadiksi</h2>
          <p>Formadiksi adalah sebuah organisasi berbasis kekeluargaan yang menaungi dan merangkul mahasiswa bidikmisi Polbeng, organisasi ini bertujuan untuk mempersatukan mahasiswa bidikmisi Polbeng dan saling berbagi informasi terkait bidikmisi. Bukan perkara mudah melahirkan sebuah organisasi yang menampung ribuan mahasiswa. Semangat pantang menyerah, solid, dan terkoordinir para pendahulu era 2016 mampu menegakkan organisasi bidikmisi Polbeng menjadi organisasi yang besar dan mampu mempersatukan teman-teman mahasiswa bidikmisi Polbeng</p>
