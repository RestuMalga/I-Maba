    ...
    <div class="row align-items-md-stretch bg-light border ">
      <div class="col-md-6">
        <div class="h-100 p-5 rounded-3">
          <img class="bi me-3" width="500px" height="350px" src="../res/bem.jpg">
        </div>
      </div>
      <div class="col-md-6">
        <div class="h-100 p-5 rounded-3">
          <h2>BEM</h2>
          <p>BEM atau Badan Eksekutif Mahasiswa merupakan organisasi yang kegiatannya sangat direkomendasikan untuk diikuti oleh mahasiswa. Sesuai dengan namannya, Badan Eksekutif Mahasiswa sebagai organisasi mahasiswa untuk tingkat Universitas ataupun institute. Tugas Dari BEM tersebut pun melingkupi banyak hal. Mulai melaksanakan program kerja (proker) yang ada di kampus hingga menjadi perwakilan aspirasi mahasiswa.</p>
