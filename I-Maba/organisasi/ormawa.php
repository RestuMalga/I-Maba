  ...
  <div class="container marketing py-5">
    ...
    <div class="row">
      <div class="col-lg-4 bg-light border">
          ...
          <h2>MPM</h2>
          <p>Mahasiswa dapat melihat informasi Organisasi Majelis Permusyawaratan Mahasiswa</p>
          <p><a class="btn btn-secondary" href="mpm.php">View</a></p>
        </div><!-- /.col-lg-4 -->
        <div class="col-lg-4 bg-light border">
          ...
          <h2>BEM</h2>
          <p>Mahasiswa dapat melihat informasi Organisasi Badan Eksekutif Mahasiswa</p>
          <p><a class="btn btn-secondary" href="bem.php">View</a></p>
        </div><!-- /.col-lg-4 -->
        <div class="col-lg-4 bg-light border">
          ...
          <h2>HMJ</h2>
          <p>Mahasiswa dapat melihat informasi Organisasi Himpunan Mahasiswa Jurusan</p>
          <p><a class="btn btn-secondary" href="hmj.php">View</a></p>
        </div><!-- /.col-lg-4 -->
    </div><!-- /.row -->
    <div class="row py-5">
        <div class="col-lg-4 bg-light border">
          ...
          <h2>UKM</h2>
          <p>Mahasiswa dapat melihat informasi Organisasi Unit Kegiatan Mahasiswa</p>
          <p><a class="btn btn-secondary" href="ukm.php">View</a></p>
        </div><!-- /.col-lg-4 -->
        <div class="col-lg-4 bg-light border">
          ...
          <h2>FORMADIKSI</h2>
          <p>Mahasiswa dapat melihat informasi Forum Mahasiswa Bidikmisi dan KIP Kuliah </p>
          <p><a class="btn btn-secondary" href="formadiksi.php">View</a></p>
        </div><!-- /.col-lg-4 -->
    </div><!-- /.row -->
